...
<head>
  ...
  <link rel="stylesheet" href="css/cart-checkout-page.css"/>
</head>
<body>
  ...
  <div class="product-container">
    <form action="orders/cart-process-checkout.php" method="POST" class="product-box">
      ...
      <div class="product-checkout-inputs">
        ...
        <!-- Customization input styled like the direct checkout -->
        <div class="product-customizations mb-3">
          <label><strong>Message (Optional):</strong></label>
          <textarea name="customization" rows="3" placeholder="Type your customization/request here..." style="width: 100%; height: 150px; resize: vertical;" 
                    oninput="document.getElementById('customizationInput0').value = this.value;"></textarea>
        </div>
