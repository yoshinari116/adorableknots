...
<head>
    ...
    <title>Checkout - <?= htmlspecialchars($products[0]['product_name']) ?></title>
...
<body>
        ...
        <form action="orders/process-checkout.php" method="POST" class="product-box">
            ...
            <div class="product-checkout-inputs">
                ...
                <div class="quantity-container my-3 d-flex align-items-center justify-content-center gap-2">
                    ...
                    <input type="hidden" name="products[<?= $index ?>][quantity]" value="1" id="hiddenQuantity<?= $index ?>">
                </div>
    ...
    <script>
        document.querySelector('input[name="quantity"]').addEventListener('input', function () {
            document.getElementById('hiddenQuantity<?= $index ?>').value = this.value;
        });
    </script>
